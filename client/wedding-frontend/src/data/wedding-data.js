export const weddingData = {
  ...
  colors: {
    primary: "Azul Serenity",
    secondary: "Branco",
  },

  hashtag: "#ArturESara2026",
  ...
  dressCode: {
    ...
    men: {
      ...
      colors:
        "Qualquer cor exceto cinza (reservado para o noivo). Camisas em azul claro ou branco são bem-vindas para complementar nossas cores.",
    },
    women: {
      items: [
  ...
  gifts: {
    ...
    paymentInfo:
      "Todos os pagamentos são processados com segurança através do MercadoPago, garantindo que sua transação seja segura e confiável.",
  },
};
